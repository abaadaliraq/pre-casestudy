  ...
  return (
    <div className="w-full max-w-md rounded-[2rem] border border-white/10 bg-white/[0.045] p-7 shadow-2xl backdrop-blur-xl">
      ...
      <p className="mt-4 text-sm leading-7 text-white/55">
        أدخل كلمة المرور لفتح دراسة الجدوى والعرض الاستثماري لمنصة كيشيب.
      </p>
      ...
      <p className="mt-6 text-xs leading-6 text-white/35">
        ملاحظة: هذا الدخول مخصص لحماية رابط العرض من الوصول العام، وليس نظام
        صلاحيات كامل للمستخدمين.
      </p>
    </div>
  );
}
